...
from app.schemas.practitioner.response import (
    ...
    PractitionerNamesListResponse, PractitionerIdentifiersListResponse,
    PractitionerTelecomListResponse, PractitionerAddressesListResponse,
    PractitionerPhotosListResponse, PractitionerQualificationsListResponse,
    PractitionerCommunicationsListResponse,
    FHIRPractitionerNamesListResponse, FHIRPractitionerIdentifiersListResponse,
    FHIRPractitionerTelecomListResponse, FHIRPractitionerAddressesListResponse,
    FHIRPractitionerPhotosListResponse, FHIRPractitionerQualificationsListResponse,
