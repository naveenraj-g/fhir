...
Revision ID: 1db5ef32e981
Revises: 
Create Date: 2026-05-27 19:57:35.689774
...
def upgrade() -> None:
    ...
    # Create public ID sequences with correct start values
    op.execute("CREATE SEQUENCE IF NOT EXISTS allergy_intolerance_pub_seq START WITH 260000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS appointment_pub_seq START WITH 40000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS audit_event_pub_seq START WITH 340000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS care_plan_pub_seq START WITH 290000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS claim_response_pub_seq START WITH 180000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS claim_pub_seq START WITH 170000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS condition_pub_seq START WITH 120000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS coverage_pub_seq START WITH 240000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS device_request_pub_seq START WITH 130000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS diagnostic_report_pub_seq START WITH 110000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS document_reference_pub_seq START WITH 320000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS encounter_pub_seq START WITH 20000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS episode_of_care_pub_seq START WITH 350000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS healthcare_service_pub_seq START WITH 150000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS immunization_pub_seq START WITH 330000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS invoice_pub_seq START WITH 210000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS location_pub_seq START WITH 230000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS medication_request_pub_seq START WITH 90000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS medication_pub_seq START WITH 250000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS observation_pub_seq START WITH 160000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS organization_pub_seq START WITH 190000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS patient_pub_seq START WITH 10000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS practitioner_role_pub_seq START WITH 140000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS practitioner_pub_seq START WITH 30000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS procedure_pub_seq START WITH 100000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS provenance_pub_seq START WITH 270000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS questionnaire_response_pub_seq START WITH 60000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS related_person_pub_seq START WITH 300000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS schedule_pub_seq START WITH 200000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS service_request_pub_seq START WITH 80000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS slot_pub_seq START WITH 220000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS specimen_pub_seq START WITH 310000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS task_pub_seq START WITH 280000 INCREMENT BY 1")
    op.execute("CREATE SEQUENCE IF NOT EXISTS vitals_pub_seq START WITH 70000 INCREMENT BY 1")
    ...
    # item first (no parent_answer_id FK yet)
    ...
    # answer (references item which now exists)
    ...
    # deferred FK: item.parent_answer_id -> answer.id
    op.create_foreign_key(None, 'questionnaire_response_item', 'questionnaire_response_answer', ['parent_answer_id'], ['id'])
